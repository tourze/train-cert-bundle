...
final class CertificateWorkflowTest extends AbstractEntityTestCase
{
    ...
    {
        return [
            'title' => ['title', 'Test Certificate'],
            'imgUrl' => ['imgUrl', '/certificates/test.pdf'],
            'valid' => ['valid', true],
        ];
    }
    ...
    public function testCertificateWorkflow(): void
    {
        ...
        $application->setRequiredDocuments(['id_card' => '身份证', 'training_cert' => '培训证明']);
