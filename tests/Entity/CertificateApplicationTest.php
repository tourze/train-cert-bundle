 ...
 * @internal
 */
#[CoversClass(CertificateApplication::class)]
final class CertificateApplicationTest extends AbstractEntityTestCase
{
    ...
    {
        return [
            'applicationType' => ['applicationType', 'test_value'],
            'applicationStatus' => ['applicationStatus', 'test_value'],
        ];
    }
